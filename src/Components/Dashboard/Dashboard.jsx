            ...
            <div className="dashboard-body-left">
              <div className="earning-box">
                <div className="main">
                  ...
                  <div className="paper-right-box">
                    <div className="paper-right-box1">Total Earnings</div>
                    <div className="paper-right-box2">₹4000</div>
                  </div>
                  <Select placeholder="PRK Hospital" w="183px" ml="286px">
                    <option value="option1">Option 1</option>
                    <option value="option2">Option 2</option>
                    <option value="option3">Option 3</option>
                  </Select>
                  <Select placeholder="Last 7 days" w="183px" ml="24px">
                    <option value="option1">Option 1</option>
                    <option value="option2">Option 2</option>
                    <option value="option3">Option 3</option>
                  </Select>
